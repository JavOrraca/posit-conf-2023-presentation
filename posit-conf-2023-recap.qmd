...
format: 
  revealjs:
    ...
    title-slide-attributes:
      data-background-image: images/centene_logo_white.svg
...
- Approximately [1,200]{.fragment .highlight-teal} workshop in-person attendees and over [2,000]{.fragment .highlight-teal} virtual attendees
- Centene had [8]{.fragment .highlight-teal} employees attend this year
...
- Important to note that my laptop would not be able to load this object into memory or the RStudio IDE
:::
...
{{< include benchmark_arrow_read.qmd >}}
:::
...
{{< include benchmark_arrow_dplyr.qmd >}}
:::
...
- We could start with a few points and search the space using an iterative approach via the `finetune` package:
